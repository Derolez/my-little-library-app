...
import { updateMemberById } from '@/lib/actions';
...
export default function EditMemberForm({ member }: { member: MemberData }) {
    ...
    const updateMemberWithId = updateMemberById.bind(null, String(member._id));
    ...
    return (
        <form 
            ...
            action={async (formData: FormData) => {
                setError(null);
                setFieldErrors({});
                const result = await updateMemberWithId(formData);
                if (result.success) {
